...
export const generateUploadUrl = mutation(async (ctx) => {
  ...
  console.log("Convex generateUploadUrl identity:", identity);
  if (!identity) throw new Error("Unauthorized: No user identity found. Make sure you are logged in and your frontend is sending a valid Clerk JWT.");
